...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">        
            ...
            <div class="card pub_image pub_imagen_detail">
                ...
                <div class="card-body">
                    ...
                    <!-- si el usuario existe yy si el usuario es igual igual al dueño de la imagen id-->
                            ...
                            <div class="modal" id="myModal">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-body">
                                        Si elíminas esta imagen nunca podrás recuperarla, ¿Estas Seguro?
                                    </div>
